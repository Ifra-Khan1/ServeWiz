...
<div class="container mt-2">
  <h2 class="text-center" style="color:#06A3DA;">Add ServiceProvider</h2>
  <form class="row g-3 form-group " method="post" action="adddoctor.php">
    ...
    <div class="col-md-6">
      <label for="validationDefault04" class="form-label">ServiceProvider</label>
      <select class="form-select" name="specialization" id="validationDefault04" required>
        <option selected>ServiceProvider</option>
    ...
    <div class="col-12">
      <button class="btn btn-primary" name="submit" type="submit">Add ServiceProvide</button>
    </div>
  </form>
</div>
