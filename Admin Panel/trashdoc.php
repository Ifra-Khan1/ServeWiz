...
<div class="container-fluid pt-4">
    <div class="bg-light text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h6 class="mb-0">ServiceProvider</h6>
        </div>
        <div class="table-responsive">
            <table id="example"
                ...
                <tbody>
                    <?php
                    $fetch = "SELECT * FROM `doctors` AS d INNER JOIN `cities` AS c ON d.`Dcity` = c.`cid` WHERE d.`dstatus` = '0'";
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-success"
                                        href="restoredoc.php?id=<?php echo $row['id'] ?>">Restore</a>
                                    <a class="btn btn-sm btn-danger"
                                        href="delete2.php?id=<?php echo $row['id'] ?>">Delete</a>
                                </td>
                            </tr>
                            <?php
                        }
