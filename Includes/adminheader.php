...
<head>
    <meta charset="utf-8">
    <title>ServeWiz Admin Panel</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fas fa-handshake"></i> Admin Panel</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="far fa-hospital me-2"></i>ServiceProvider</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="add.php" class="dropdown-item nav-item nav-link">View ServiceProvider</a>
                            <a href="trashdoc.php" class="dropdown-item nav-item nav-link">Trash ServiceProvider</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="far fa-user me-2"></i>Customers</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="addpatient.php" class="dropdown-item nav-item nav-link">View Customers</a>
                            <a href="trashpat.php" class="dropdown-item nav-item nav-link">Trash Customers</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
