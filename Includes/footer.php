        ...
        <div class="row g-5 pt-4">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-light mb-2" href="doctors.php"><i class="bi bi-arrow-right text-primary me-2"></i>ServiceProvider
                    </a>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSKkwpTBQgqmfzRLCwkSkBGpPMfmSxprnRQCJTgZNDLGqQdTKkrTlfnzLZBfGZlvmvvDBDnF"
                    target="_blank" style="text-decoration: none; color:white;">
                    <p class="mb-2"><i class="bi bi-envelope-open text-primary me-2"></i>ServeWizw@gmail.com</p>
                </a>
    ...
    <div class="container">
        <div class="row g-0">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-md-0">&copy; <a class="text-white border-bottom" href="#">ServeWiz</a>. All Rights
                    Reserved.</p>
            </div>
