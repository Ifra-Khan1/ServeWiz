...
if (isset($_POST["submit"])) {
    ...
    $insert = "INSERT INTO `appointment` (`pname`, `pemail`, `pspecialization`, `pdoctor`, `pday`, `ptime`) VALUES ('$name', '$email', '$specialization','$doctor' , '$date', '$time')";
    $connection_insert = mysqli_query($connection, $insert);
    if ($connection_insert) {
        echo "
        <script>
        alert('Your Appointment Sent. Once its checked your appointment will be set as per date and time.')
</script>";
    ...
    <div class="container">
        <div class="row gx-5">
            <div class="col-lg-6 py-5">
                <div class="py-5">
                    <h1 class="display-5 text-white mb-4">We Are A ServiceProvider Agency You Can
                        Trust</h1>
                        ...
                        <div class="row g-3">
                            ...
                            if (mysqli_num_rows($query) > 0) {
                                while ($row2 = mysqli_fetch_assoc($query)) {
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <select name="pspecialization" id="doctorSelect" class="form-select bg-light border-0"
                                            style="height: 55px;">

                                            <option selected>Select A ServiceProvider</option>
                                            <?php
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class>
                                            <input type="text" id="pdoctor" name="pdoctor"
                                                class="form-control bg-light border-0" placeholder="Name"
                                                style="height: 55px;">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6">
