...
<h2 class="text-center" style="color:#06A3DA;">ServiceProvider Signup</h2>
<form class="row g-3 form-group mt-2" method="post" action="doc_signup.php">
  <div class="col-md-12">
  ...
  <div class="col-md-6">
    ...
    <input type="email" name="Demail" class="form-control" id="validationDefault02" placeholder="abc@gmail.com" required>
  </div>
  <div class="col-md-6">
    <label for="validationDefaultUsername" class="form-label">Password</label>
    <input type="password" name="Dpassword" class="form-control" id="validationDefault02" placeholder="********" required>

  </div>
  <div class="col-md-6">
    <label for="validationDefault04" class="form-label">TradePeoples</label>
